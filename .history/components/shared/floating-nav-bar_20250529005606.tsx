...
// Simple Logo component if it doesn't exist
	...
	return (
		<header className="fixed top-0 left-0 right-0 z-[100] px-4 py-4">
			<div className="mx-auto max-w-6xl">
				<nav
					className={cn(
						"backdrop-blur-md bg-[#D7FF1D]/90 border border-white/20 rounded-full px-6 py-3 transition-all duration-500 ease-out shadow-lg",
						visible && !isLoading 
