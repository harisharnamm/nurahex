...
export function LoadingOverlay({ onFinish }: { onFinish: () => void }) {
  ...
  return (
    <div
      ref={overlayRef}
      className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-bg-dark transition-opacity duration-500"
    ...
    >
      ...
      <div className="w-64 h-2 bg-white/10 rounded-full overflow-hidden">
        <div
          ref={progressRef}
          className="loading-progress h-full bg-primary rounded-full"
          style={{ width: 0 }}
        />
      </div>
    </div>
