...
export default function AIHighlights() {
  ...
  useEffect(() => {
    ...
    // Glow elements have been removed
    ...
    const sectionLength = 200; // Based on the 200vh height (updated)
    ...
    // No additional hold needed, adjust section height directly
    // Reduce the overall section height to avoid extra blank scroll
    document.querySelector('#ai-highlights').style.height = '200vh'; // Reduced from 300vh
