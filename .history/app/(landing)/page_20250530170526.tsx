  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div id="main-content" style={{ opacity: loading ? 0 : 1, transition: 'opacity 0.3s' }}>
        ...
        {/* Animated ScrollFloat Section */}
        <section className="py-24 bg-surface-950">
          <div className="container mx-auto px-6 flex flex-col gap-16 items-center">
            {/* Slide 1 */}
            <ScrollFloat
              animationDuration={1}
              ease="back.inOut(2)"
            ...
            <ScrollFloat
              ...
              stagger={0.03}
            >
              Lightning Fast Deployment – From concept to production in weeks, not months.
            </ScrollFloat>
            {/* Slide 3 */}
            <ScrollFloat
              animationDuration={1}
              ...
              stagger={0.03}
            >
              Measurable Results – Proven ROI with enterprise-grade solutions that scale.
            </ScrollFloat>
          </div>
        </section>
