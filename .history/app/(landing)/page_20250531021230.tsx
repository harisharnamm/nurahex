  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div id="main-content" style={{ opacity: loading ? 0 : 1, transition: 'opacity 0.3s' }}>
        ...
        <section className="py-16 bg-surface-700 overflow-hidden relative" id="why-nurahex">
          <BackgroundBeamsWithCollision className="absolute inset-0 bg-surface-700" />
          ...
          <div style={{ height: '450px', position: 'relative', zIndex: 10 }}>
