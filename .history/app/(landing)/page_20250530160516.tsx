...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Pinned Section with Enhanced 3D Content Reveal
      ...
      if (pinnedItems.length > 0) {
        ...
        const tl = gsap.timeline({
          scrollTrigger: {
            ...
            scrub: 3, // Even slower scrub for ultra-smooth control
            pin: true,
            anticipatePin: 1,
        ...
        pinnedItems.forEach((item, index) => {
          ...
          const startTime = index * 3.5 // Slower timing between items
          const holdTime = 2.5 // Longer hold time for better readability
          ...
          // Hold in place with subtle breathing effect
          .to(item, {
            opacity: 1,
            z: 0,
            rotationX: 0,
          ...
          if (index < pinnedItems.length - 1) {
            ...
            tl.to(item, {
              ...
              duration: 2.2,
              ease: 'power4.in'
            }, startTime + 1.8 + holdTime + 1.5)
          }
        })
        
        // Add dynamic background effects synchronized with text transitions
            ...
            <div className="container mx-auto px-6 text-center">
              <div className="pinned-content relative">
                <div className="pinned-item absolute inset-0 flex flex-col items-center justify-center">
                  <h2 className="text-4xl md:text-6xl font-bold mb-6 transform-gpu">
                    <span className="text-[#D7FF1E] drop-shadow-lg">Revolutionary</span> AI Solutions
                  </h2>
                  <p className="text-xl text-surface-50/80 max-w-3xl mx-auto leading-relaxed transform-gpu">
                    We don't just implement AI - we revolutionize how your business operates
                  </p>
                </div>
                <div className="pinned-item absolute inset-0 flex flex-col items-center justify-center">
                  <h2 className="text-4xl md:text-6xl font-bold mb-6 transform-gpu">
                    <span className="text-[#D7FF1E] drop-shadow-lg">Lightning</span> Fast Deployment
                  </h2>
                  <p className="text-xl text-surface-50/80 max-w-3xl mx-auto leading-relaxed transform-gpu">
                ...
                <div className="pinned-item absolute inset-0 flex flex-col items-center justify-center">
                  <h2 className="text-4xl md:text-6xl font-bold mb-6 transform-gpu">
                    <span className="text-[#D7FF1E] drop-shadow-lg">Measurable</span> Results
                  </h2>
                  <p className="text-xl text-surface-50/80 max-w-3xl mx-auto leading-relaxed transform-gpu">
