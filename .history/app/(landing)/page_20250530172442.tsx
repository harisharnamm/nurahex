  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div id="main-content" style={{ opacity: loading ? 0 : 1, transition: 'opacity 0.3s' }}>
        ...
        {/* Simple Scroll-Pinned Section: Three Slides */}
            ...
            <div className="w-full max-w-2xl mx-auto">
              <div className="space-y-32">
                ...
                <div className="fade-in-on-scroll text-center">
                  <h2 className="text-4xl md:text-6xl font-bold mb-4 text-[#D7FF1E]">Revolutionary AI Solutions</h2>
                  <p className="text-lg md:text-xl text-surface-50/90 max-w-xl mx-auto">We don’t just implement AI – we revolutionize how your business operates.</p>
                </div>
                {/* Slide 2 */}
                <div className="fade-in-on-scroll text-center">
                  <h2 className="text-4xl md:text-6xl font-bold mb-4 text-[#D7FF1E]">Lightning Fast Deployment</h2>
                  <p className="text-lg md:text-xl text-surface-50/90 max-w-xl mx-auto">From concept to production in weeks, not months.</p>
                </div>
                {/* Slide 3 */}
                <div className="fade-in-on-scroll text-center">
                  <h2 className="text-4xl md:text-6xl font-bold mb-4 text-[#D7FF1E]">Measurable Results</h2>
                  <p className="text-lg md:text-xl text-surface-50/90 max-w-xl mx-auto">Proven ROI with enterprise-grade solutions that scale.</p>
                </div>
              </div>
            </div>
          </div>
