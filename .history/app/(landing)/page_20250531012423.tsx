  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div id="main-content" style={{ opacity: loading ? 0 : 1, transition: 'opacity 0.3s' }}>
            ...
            <div className="relative">
              <div className="flex space-x-12 animate-marquee">
                {[
                  ...
                  // Port Oak Shipping SL partner logo
                  <div key="portoak" className="flex flex-col items-center justify-center w-40 h-20 bg-surface-600/50 rounded-lg">
                    <img src="/art/portoak-logo.png" alt="Port Oak Shipping SL" className="h-8 object-contain mb-1" />
                    <span className="text-xs text-surface-50/70">Port Oak Shipping SL</span>
                  </div>
                ]}
              </div>
            </div>
        ...
        {/* Join Our Team CTA and Open Positions */}
        <section className="py-20 bg-surface-900 border-t border-surface-700">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-lg text-surface-50/80 mb-8 max-w-2xl mx-auto">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-4xl mx-auto">
              {/* Example open positions, update as needed */}
              <div className="bg-surface-800 rounded-lg p-6 text-left">
                <h4 className="text-xl font-semibold mb-2">AI Solutions Engineer</h4>
                <p className="text-surface-50/70 mb-2">Remote / Contract</p>
                <Link href="/careers#ai-solutions-engineer" className="text-primary-700 font-medium hover:underline">Learn more</Link>
              </div>
              <div className="bg-surface-800 rounded-lg p-6 text-left">
                <h4 className="text-xl font-semibold mb-2">Frontend Developer</h4>
                <p className="text-surface-50/70 mb-2">Remote / Full-time</p>
                <Link href="/careers#frontend-developer" className="text-primary-700 font-medium hover:underline">Learn more</Link>
              </div>
              <div className="bg-surface-800 rounded-lg p-6 text-left">
                <h4 className="text-xl font-semibold mb-2">Product Designer</h4>
                <p className="text-surface-50/70 mb-2">Remote / Part-time</p>
                <Link href="/careers#product-designer" className="text-primary-700 font-medium hover:underline">Learn more</Link>
              </div>
            </div>
          </div>
        </section>
