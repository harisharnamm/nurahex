  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div id="main-content" style={{ opacity: loading ? 0 : 1, transition: 'opacity 0.3s' }}>
        ...
        <section ref={pinnedSectionRef} className="pinned-section relative h-[180vh] bg-surface-950">
          {/* Dynamic background overlay */}
          <div className="absolute inset-0 bg-gradient-to-b from-surface-950/80 via-surface-900/60 to-surface-950/80 z-0"></div>
          <div className="absolute inset-0 bg-gradient-radial from-primary-700/5 via-transparent to-transparent opacity-30 z-0"></div>
