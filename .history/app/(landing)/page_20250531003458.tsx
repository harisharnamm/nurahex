...
export default function Home() {
  ...
  const demoItems = [
    { link: '#', text: 'Transformative AI Solutions', image: 'https://picsum.photos/600/400?random=1' },
    { link: '#', text: 'Lightning Fast Deployment', image: 'https://picsum.photos/600/400?random=2' },
    { link: '#', text: 'Measurable Results', image: 'https://picsum.photos/600/400?random=3' },
  ];
