      ...
      <div id="main-content" style={{ opacity: loading ? 0 : 1, transition: 'opacity 0.3s' }}>
        ...
        <section className="py-24 bg-surface-950">
          <div className="container mx-auto px-6 flex flex-col items-center">
            <h2 className="text-3xl md:text-4xl font-bold font-space-grotesk text-center mb-10 text-surface-50">
              Why NurahexAI?
            </h2>
