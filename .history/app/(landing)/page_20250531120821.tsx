        ...
        <section ref={socialProofRef} className="py-16 bg-surface-700 overflow-hidden">
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {/* Testimonial 1 */}
              <div className="bg-surface-600/50 rounded-lg p-6 flex flex-col items-center text-center">
                <span className="text-xl italic text-surface-50/80 mb-4">"NurahexAI transformed our customer support operations with their AI solution. We've seen a 70% reduction in response time and significantly improved customer satisfaction."</span>
                <span className="font-medium mt-2">Sarah Johnson</span>
                <span className="text-sm text-surface-50/60">CTO, TechCorp</span>
              </div>
              {/* Testimonial 2 */}
              <div className="bg-surface-600/50 rounded-lg p-6 flex flex-col items-center text-center">
                <span className="text-xl italic text-surface-50/80 mb-4">"The intelligent system NurahexAI built for us has completely transformed how we process data. What used to take days now happens in hours, with fewer errors and more consistent results."</span>
                <span className="font-medium mt-2">Michael Chen</span>
                <span className="text-sm text-surface-50/60">Head of Data, GrowthLabs</span>
              </div>
              {/* Testimonial 3 */}
              <div className="bg-surface-600/50 rounded-lg p-6 flex flex-col items-center text-center">
                <span className="text-xl italic text-surface-50/80 mb-4">"NurahexAI's innovative solution has not only saved us money but has also helped us reduce our environmental impact. It's a win-win for our business and our mission."</span>
                <span className="font-medium mt-2">Emma Rodriguez</span>
                <span className="text-sm text-surface-50/60">COO, EcoSystems</span>
              </div>
            </div>
          </div>
        </section>
