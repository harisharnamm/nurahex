                ...
                {[
                  ...
                  <>
                    ...
                    <div key="portoak" className="flex flex-col items-center justify-center w-40 h-20 bg-surface-600/50 rounded-lg">
                      <img src="https://oaksl.ae/wp-content/uploads/2024/06/Logo_PNG-1.png-removebg-preview-1.png" alt="Port Oak Shipping SL" className="h-8 object-contain mb-1" />
                      <span className="text-xs text-surface-50/70">Port Oak Shipping SL</span>
                    </div>
                    {/* OneCube partner logo */}
                    <div key="onecube" className="flex flex-col items-center justify-center w-40 h-20 bg-surface-600/50 rounded-lg">
                      <img src="https://onecube.in/cdn/shop/files/Screenshot_2025-01-02_at_2.30.57_PM.png?v=1735808475&width=200" alt="OneCube" className="h-8 object-contain mb-1" />
                      <span className="text-xs text-surface-50/70">OneCube</span>
                    </div>
                  </>
                ]}
              </div>
