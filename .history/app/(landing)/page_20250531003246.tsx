...
export default function Home() {
  ...
  const demoItems = [
    { link: '#', text: 'AI Automation', image: 'https://picsum.photos/600/400?random=1' },
    { link: '#', text: 'Digital Intelligence', image: 'https://picsum.photos/600/400?random=2' },
    { link: '#', text: 'Smart Workflows', image: 'https://picsum.photos/600/400?random=3' },
    { link: '#', text: 'Future Ready', image: 'https://picsum.photos/600/400?random=4' }
  ];
        ...
        <section className="relative bg-surface-800 overflow-hidden">
          <div className="text-center py-12 px-6">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Explore Our <span className="text-primary-700">AI Solutions</span>
            </h2>
            <p className="text-lg text-surface-50/80 max-w-2xl mx-auto">
              Discover how our intelligent automation transforms industries and accelerates growth
            </p>
          </div>
