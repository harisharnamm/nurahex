          ...
          <div className="container mx-auto px-6">
            ...
            <div className="flex flex-col items-center">
              <div className="relative w-full max-w-xl">
                <div className="bg-surface-600/50 rounded-lg p-6 flex flex-col items-center text-center min-h-[220px] transition-all duration-500">
                  <span className="text-xl italic text-surface-50/80 mb-4">"{testimonials[testimonialIndex].quote}"</span>
                  <span className="font-medium mt-2">{testimonials[testimonialIndex].name}</span>
                  <span className="text-sm text-surface-50/60">{testimonials[testimonialIndex].title}</span>
                </div>
                {/* Navigation Buttons */}
                <button onClick={handlePrev} aria-label="Previous testimonial" className="absolute left-0 top-1/2 -translate-y-1/2 bg-surface-800/80 hover:bg-surface-900 text-surface-50 rounded-full p-2 shadow transition-all duration-200">
                  <svg width="20" height="20" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeWidth="2" d="M15 19l-7-7 7-7"/></svg>
                </button>
                <button onClick={handleNext} aria-label="Next testimonial" className="absolute right-0 top-1/2 -translate-y-1/2 bg-surface-800/80 hover:bg-surface-900 text-surface-50 rounded-full p-2 shadow transition-all duration-200">
