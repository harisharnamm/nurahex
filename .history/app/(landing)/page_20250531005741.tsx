    ...
    if (problemRef.current) {
      ...
      gsap.fromTo(
        ...
        { 
          ...
          duration: 0.6, 
          stagger: 0.1,
          delay: 0.7, // Increased from 0.4 to appear after title and description
          ease: "power2.out",
          scrollTrigger: { 
            trigger: problemRef.current, 
            start: "top 80%",
      ...
      gsap.fromTo(
        ...
        { 
          ...
          scale: 1, 
          duration: 1, 
          delay: 0.6, // Increased from 0.3 to appear after description
          ease: "power2.out",
          scrollTrigger: { 
            trigger: problemRef.current, 
            start: "top 80%",
    ...
    if (servicesRef.current) {
      ...
      gsap.fromTo(
        ...
        { 
          ...
          delay: 0.6, // Increased from 0.2 to appear after title and description
          ease: "power2.out",
          scrollTrigger: { 
            trigger: servicesRef.current, 
            start: "top 80%",
          ...
          <div className="container mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                <AnimatedText animation="splitWords" delay={0} className="text-3xl md:text-4xl font-bold">
        ...
        <section ref={servicesRef} className="py-16 bg-surface-900 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="text-center mb-16">
              <AnimatedText animation="splitWords" delay={0} className="text-3xl md:text-4xl font-bold mb-4">
