          ...
          <div className="container mx-auto px-6">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-24">
                {[
                  { number: "01", title: "Discovery", description: "We analyze your business needs and identify opportunities for AI implementation." },
                  { number: "02", title: "Strategy", description: "We develop a tailored AI strategy aligned with your business goals." },
                  { number: "03", title: "Implementation", description: "Our team builds and integrates custom AI solutions into your existing systems." },
                  { number: "04", title: "Execution", description: "We continuously monitor and optimize your AI solutions for maximum performance." }
                ].map((step, index) => (
