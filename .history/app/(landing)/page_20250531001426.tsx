...
import "@/components/home/FlowingMenu.css"
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div id="main-content" style={{ opacity: loading ? 0 : 1, transition: 'opacity 0.3s' }}>
        ...
        {/* Value Props Flowing Menu Section */}
        <section className="py-24 bg-surface-950">
          <div className="container mx-auto px-6 flex flex-col items-center">
            <h2 className="text-3xl md:text-4xl font-bold font-space-grotesk text-center mb-16 text-surface-50 tracking-tight">
              Why NurahexAI?
            </h2>
            <div className="flex flex-col gap-8 w-full">
              {[
                ...
                <div
                  ...
                  tabIndex={0}
                  className={
                    "group relative w-full bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-3xl p-8 flex flex-col items-center justify-center min-h-[220px] shadow-xl backdrop-blur-md transition-all duration-300 outline-none focus:ring-2 focus:ring-primary-700 hover:scale-[1.025] hover:shadow-2xl focus:scale-[1.025] cursor-pointer"
                  }
