  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div id="main-content" style={{ opacity: loading ? 0 : 1, transition: 'opacity 0.3s' }}>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                ...
                <Image
                  ...
                  width={500}
                  height={600}
                  className="rounded-lg shadow-md relative z-10 border border-surface-600 problem-image"
                />
              </div>
            </div>
          </div>
        ...
        {/* Pinned Section with Content Reveal */}
        <section ref={pinnedSectionRef} className="pinned-section relative h-[200vh] bg-surface-950">
          <div className="sticky top-0 h-screen flex items-center justify-center overflow-hidden">
            <div className="container mx-auto px-6 text-center">
              <div className="pinned-content space-y-8">
                <div className="pinned-item">
                  <h2 className="text-4xl md:text-6xl font-bold mb-6">
                    <span className="text-[#D7FF1E]">Revolutionary</span> AI Solutions
                  </h2>
                  <p className="text-xl text-surface-50/80 max-w-3xl mx-auto">
        ...
        {/* Service Cards Grid */}
        <section ref={servicesRef} className="py-24 bg-surface-900 relative overflow-hidden">
        ...
        {/* Curiosity CTA Section (insert before case studies) */}
        <CuriosityCTASection />

        {/* Case Study Preview */}
        <section ref={caseStudiesRef} className="py-24 bg-surface-700">
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12">
              <div>
                <AnimatedText animation="splitWords" className="text-3xl md:text-4xl font-bold mb-4">
                  Success <span className="text-primary-700">Stories</span>
                </AnimatedText>
                <AnimatedText animation="slideIn" delay={0.2} className="text-lg text-surface-50/80 max-w-2xl">
                  See how we've helped companies transform their operations with AI.
                </AnimatedText>
              </div>
              <MagneticButton>
                <SecondaryLink href="/about" className="mt-4 md:mt-0">
                  Learn about our approach <ArrowRight className="ml-2 h-4 w-4" />
                </SecondaryLink>
              </MagneticButton>
            </div>

            {/* Case Studies Grid */}
            <div className="case-studies-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
              {[
                  {
                    title: "TechCorp",
                    metric: "3.5x",
                  ...
                  },
                  {
                    title: "DataFlow",
                    metric: "45%",
                    description: "Improved data accuracy with machine learning models",
                    image: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=600&q=80",
                  },
                  {
                    title: "InnovateCorp",
                    metric: "2.8x",
                    description: "Faster decision making with AI-powered analytics",
                    image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=600&q=80",
                  },
                ].map((caseStudy, index) => (
                  <Link href={`/case-studies/${caseStudy.title.toLowerCase()}`} key={index}>
                    <CardGlass className="h-full overflow-hidden group case-study-item">
                      <div className="relative h-48 -mx-6 -mt-6 mb-6 overflow-hidden">
                        ...
                        <div className="absolute bottom-4 left-4 bg-primary-700 text-primary-foreground px-3 py-1 rounded-full text-sm font-medium">
                          {caseStudy.title}
                        </div>
                      </div>
                      <div className="space-y-2">
                        <div className="flex items-baseline gap-2">
                          <span className="text-3xl font-bold text-primary-700 case-study-metric">{caseStudy.metric}</span>
                          <span className="text-surface-50/70">improvement</span>
                        </div>
                        <AnimatedText animation="slideUp" delay={0.1} className="text-surface-50/80">
                          {caseStudy.description}
                        </AnimatedText>
                        <div className="flex items-center pt-2 text-[#D7FF1E] opacity-0 group-hover:opacity-100 transition-opacity case-study-cta">
                          <span className="group-hover:text-[#D7FF1E]">Read case study</span>
                          <ArrowRight className="ml-2 h-4 w-4 group-hover:text-[#D7FF1E]" />
                        </div>
                      </div>
                    </CardGlass>
                  </Link>
