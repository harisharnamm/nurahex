                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">eashan@nurahexai.com</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">+1 (519) 555-0123</p>
                      <p className="text-white/70">+91 9810106849</p>
                      <p className="text-white/70">+91 9953286606</p>
                    </div>
                  </div>
                  <div>
