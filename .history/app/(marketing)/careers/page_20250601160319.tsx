					...
					<div className="space-y-4">
						...
						<div className="flex flex-col md:flex-row items-center justify-between bg-surface-800 rounded-lg p-6">
							<div>
								...
								<p className="text-surface-50/70">Remote / Full-time / Intern</p>
							</div>
						...
						<div className="flex flex-col md:flex-row items-center justify-between bg-surface-800 rounded-lg p-6">
							<div>
								<h4 className="text-xl font-semibold mb-1"> Gen-AI Designer </h4>
								<p className="text-surface-50/70">Remote / Full-time / Intern</p>
							</div>
							<PrimaryButton asChild className="mt-4 md:mt-0">
						...
						<div className="flex flex-col md:flex-row items-center justify-between bg-surface-800 rounded-lg p-6">
							<div>
								<h4 className="text-xl font-semibold mb-1">Gen-AI Video Creator</h4>
								<p className="text-surface-50/70">Remote / Part-time / Intern</p>
							</div>
							<PrimaryButton asChild className="mt-4 md:mt-0">
