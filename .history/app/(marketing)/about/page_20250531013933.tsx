      ...
      <section className="py-20 bg-bg-dark/90">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold mb-4 text-center flex items-center justify-center gap-2">
            <span role="img" aria-label="fire">🔥</span> Our Core Values – We Bring the HEAT
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <CardGlass className="h-full flex flex-col items-center text-center">
          ...
          <h3 className="text-2xl font-bold mb-6 text-center flex items-center justify-center gap-2">
            <span role="img" aria-label="sparkles">✨</span> Additional Values that Drive Us
          </h3>
