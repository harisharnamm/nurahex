      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-surface-900">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            ...
            <div className="md:col-span-2 bg-gradient-to-br from-primary-700 to-primary-500 rounded-2xl p-8 flex flex-col items-center justify-center text-center min-h-[280px]">
              <div className="mb-6">
