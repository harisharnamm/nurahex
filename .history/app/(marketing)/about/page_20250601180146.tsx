        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 relative">
            ...
            <CardGlass className="h-full">
              ...
              <p className="text-white/70">We believe in clear, truthful communication — with our clients, our partners, and within our team. Integrity is the cornerstone of trust, and we never compromise on it.</p>
            </CardGlass>
            ...
            <CardGlass className="h-full">
              ...
              <p className="text-white/70">We are committed to inclusivity and equal opportunity — ensuring our automation solutions empower all businesses, regardless of size, industry, or geography.</p>
            </CardGlass>
            ...
            <CardGlass className="h-full">
              ...
              <p className="text-white/70">We take ownership of our actions and their impact. We deliver on promises, stand by our outcomes, and hold ourselves to the highest standards.</p>
            </CardGlass>
            ...
            <CardGlass className="h-full">
              ...
              <p className="text-white/70">We operate with openness in our processes, pricing, and partnerships. No hidden agendas, just straightforward collaboration and results.</p>
            </CardGlass>
            
            {/* Center HEAT element - positioned absolutely */}
            <div className="hidden md:block absolute inset-0 z-10 flex items-center justify-center">
              <div className="rounded-lg border border-white/10 bg-surface-900/90 backdrop-blur-xl p-6 shadow-xl transform transition-transform hover:scale-105 w-48 h-48 flex items-center justify-center">
                <h2 className="text-6xl font-bold tracking-wider text-primary">HEAT</h2>
              </div>
            </div>
            
            {/* Mobile only HEAT element */}
            <div className="col-span-2 md:hidden flex items-center justify-center mt-4">
              <div className="rounded-lg border border-white/10 bg-surface-900/90 backdrop-blur-xl p-6 shadow-xl w-48 h-48 flex items-center justify-center">
                <h2 className="text-6xl font-bold tracking-wider text-primary">HEAT</h2>
              </div>
            </div>
          </div>
