      ...
      <section className="py-20 bg-bg-dark/90">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-3 gap-8">
            ...
            {/* Central HEAT highlight card */}
            <div className="flex justify-center items-center h-full md:col-span-3 lg:col-span-1">
              <div className="rounded-lg border border-white/10 bg-surface-900/60 backdrop-blur-xl p-6 flex items-center justify-center transform transition-transform hover:scale-105">
                <h2 className="text-6xl md:text-7xl font-bold tracking-wider text-primary">HEAT</h2>
              </div>
            </div>
