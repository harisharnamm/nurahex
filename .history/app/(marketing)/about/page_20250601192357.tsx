      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-surface-900">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-5xl mx-auto">
            {/* Honesty - Top Left */}
            <div className="md:col-span-1 lg:col-span-2 bg-surface-700 border border-surface-600 rounded-2xl p-8 hover:border-primary-700/50 transition-all duration-300">
            ...
            <div className="md:col-span-1 lg:col-span-3 bg-surface-700 border border-surface-600 rounded-2xl p-8 hover:border-primary-700/50 transition-all duration-300">
            ...
            {/* Central HEAT Card */}
            <div className="md:col-span-3 lg:col-span-1 lg:row-span-2 bg-gradient-to-br from-primary-700 to-primary-500 rounded-2xl p-8 flex flex-col items-center justify-center text-center min-h-[280px]">
              <div className="mb-6">
                <div className="w-20 h-20 bg-surface-950/20 rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-surface-950/90 text-sm leading-relaxed">
                The fire that fuels our innovation, the passion that drives our excellence, 
                and the energy that powers our commitment to transforming the future.
              </p>
            </div>

            {/* Adaptability - Bottom Left */}
            <div className="md:col-span-1 lg:col-span-2 bg-surface-700 border border-surface-600 rounded-2xl p-8 hover:border-primary-700/50 transition-all duration-300">
