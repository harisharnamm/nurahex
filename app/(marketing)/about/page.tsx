...
export default function AboutPage() {
  return (
    <div className="pt-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/80 mb-6">
                At NurahexAI, we believe that AI should be accessible to businesses of all sizes. Our mission is to
                democratize AI by providing production-ready solutions that deliver real business value without the
                complexity and high costs typically associated with AI implementation.
              </p>
      ...
      {/* Team Section */}
      <section className="py-20 bg-bg-dark" id="careers">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
